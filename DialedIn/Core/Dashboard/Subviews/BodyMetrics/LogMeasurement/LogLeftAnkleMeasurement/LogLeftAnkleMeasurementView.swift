//
//  LogLeftAnkleMeasurementView.swift
//  DialedIn
//
...
struct LogLeftAnkleMeasurementView: View {

    @State var presenter: LogLeftAnkleMeasurementPresenter
    ...
    var body: some View {
        ...
        .navigationTitle("Log Left Ankle Measurement")
    ...
    private var measurementPickerSection: some View {
        Section {
            if presenter.unit == .centimeters {
                Picker("Left Ankle Circumference", selection: $presenter.selectedCentimeters) {
                ...
                Picker("Left Ankle Circumference", selection: $presenter.selectedInches) {
...
extension CoreBuilder {
    func logLeftAnkleMeasurementView(router: AnyRouter) -> some View {
        LogLeftAnkleMeasurementView(
            presenter: LogLeftAnkleMeasurementPresenter(interactor: interactor, router: CoreRouter(router: router, builder: self))
        )
    }
}

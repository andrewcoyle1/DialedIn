...
class RecipesPresenter {
    ...
    func onRecipePressedFromFavourites(recipe: RecipeTemplateModel, delegate: RecipesDelegate) {
        interactor.trackEvent(event: Event.onRecipePressedFromFavourites)
        onRecipePressed(recipe: recipe)
    }

    func onRecipePressedFromBookmarked(recipe: RecipeTemplateModel, delegate: RecipesDelegate) {
        interactor.trackEvent(event: Event.onRecipePressedFromBookmarked)
        onRecipePressed(recipe: recipe)
    }

    func onRecipePressedFromTrending(recipe: RecipeTemplateModel, delegate: RecipesDelegate) {
        interactor.trackEvent(event: Event.onRecipePressedFromTrending)
        onRecipePressed(recipe: recipe)
    }

    func onRecipePressedFromMyTemplates(recipe: RecipeTemplateModel, delegate: RecipesDelegate) {

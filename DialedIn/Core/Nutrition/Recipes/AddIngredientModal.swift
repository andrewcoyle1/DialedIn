...
#Preview {
    ...
    .sheet(isPresented: $showModal) {
        AddIngredientModal(viewModel: AddIngredientModalViewModel(interactor: CoreInteractor(container: DevPreview.shared.container)), selectedIngredients: $selectedIngredients)
    }
    .previewEnvironment()
}

...
struct EditableExerciseCardWrapper: View {
    ...
    @State private var localExercise: WorkoutExerciseModel
    ...
    init(
        ...
        self._localExercise = State(initialValue: exercise)
    }
    ...
    var body: some View {
        ...
        .onChange(of: localExercise) { _, newValue in
            onExerciseUpdate(newValue)
        }
        .onAppear {

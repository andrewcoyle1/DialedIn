//
//  OnboardingTargetWeightPresenter.swift
//  DialedIn
//
...
@Observable
@MainActor
class OnboardingTargetWeightPresenter {
    ...
    func navigateToWeightRate(weightGoalBuilder: WeightGoalBuilder) {
        ...
        router.showOnboardingWeightRateView(delegate: OnboardingWeightRateDelegate(weightGoalBuilder: builder))
    }

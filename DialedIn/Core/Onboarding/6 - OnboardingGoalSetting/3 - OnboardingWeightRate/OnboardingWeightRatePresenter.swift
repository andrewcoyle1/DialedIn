//
//  OnboardingWeightRatePresenter.swift
//  DialedIn
//
...
@Observable
@MainActor
class OnboardingWeightRatePresenter {
    ...
    func navigateToGoalSummary(weightGoalBuilder: WeightGoalBuilder) {
        ...
        router.showOnboardingGoalSummaryView(delegate: OnboardingGoalSummaryDelegate(weightGoalBuilder: builder))
    }

//
//  OnboardingPreferredDietPresenter.swift
//  DialedIn
//
...
@Observable
@MainActor
class OnboardingPreferredDietPresenter {
    ...
    func navigateToCalorieFloor() {
        if let diet = selectedDiet {
            ...
            router.showOnboardingCalorieFloorView(delegate: OnboardingCalorieFloorDelegate(dietPlanBuilder: dietPlanBuilder))
        }
    }

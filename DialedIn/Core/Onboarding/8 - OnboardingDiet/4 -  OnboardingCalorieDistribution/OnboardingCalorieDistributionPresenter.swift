//
//  OnboardingCalorieDistributionPresenter.swift
//  DialedIn
//
...
@Observable
@MainActor
class OnboardingCalorieDistributionPresenter {
    ...
    func navigateToProteinIntake(dietPlanBuilder: DietPlanBuilder) {
        if let calorieDistribution = selectedCalorieDistribution {
            ...
            router.showOnboardingProteinIntakeView(delegate: OnboardingProteinIntakeDelegate(dietPlanBuilder: builder))
        }
    }

//
//  OnboardingHeightPresenter.swift
//  DialedIn
//
...
@Observable
@MainActor
class OnboardingHeightPresenter {
    ...
    func navigateToWeightView(userBuilder: UserModelBuilder) {
        ...
        router.showOnboardingWeightView(delegate: OnboardingWeightDelegate(userModelBuilder: builder))
    }

//
//  OnboardingCardioFitnessPresenter.swift
//  DialedIn
//
...
@Observable
@MainActor
class OnboardingCardioFitnessPresenter {
    ...
    func navigateToExpenditure(userBuilder: UserModelBuilder) {
        if let cardioFitness = selectedCardioFitness {
            ...
            router.showOnboardingExpenditureView(delegate: OnboardingExpenditureDelegate(userBuilder: builder))
        }
    }

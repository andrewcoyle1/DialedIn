//
//  OnboardingWeightPresenter.swift
//  DialedIn
//
...
@Observable
@MainActor
class OnboardingWeightPresenter {
    ...
    func navigateToExerciseFrequency(userBuilder: UserModelBuilder) {
        ...
        router.showOnboardingExerciseFrequencyView(delegate: OnboardingExerciseFrequencyDelegate(userModelBuilder: builder))
    }

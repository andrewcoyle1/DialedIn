//
//  NotificationsPermissionsPresenter.swift
//  DialedIn
//
...
@Observable
@MainActor
class NotificationsPermissionsPresenter {
    private let interactor: NotificationsPermissionsInteractor
    private let router: NotificationsPermissionsRouter
    
    init(
        interactor: NotificationsPermissionsInteractor,
        router: NotificationsPermissionsRouter
    ) {
    ...
    func onEnableNotificationsPressed() {
        router.showNotificationsPermissionsModal(onConfirmPressed: onEnablePushNotificationsPressed, onCancelPressed: onCancelPushNotificationsPressed)

...
class RecipeListBuilderPresenter {
    ...
    func onRecipePressedFromFavourites(recipe: RecipeTemplateModel, onRecipePressed: ((RecipeTemplateModel) -> Void)? = nil) {
        interactor.trackEvent(event: Event.onRecipePressedFromFavourites)
        self.onRecipePressed(recipe: recipe, onRecipePressed: onRecipePressed)
    }

    func onRecipePressedFromBookmarked(recipe: RecipeTemplateModel, onRecipePressed: ((RecipeTemplateModel) -> Void)? = nil) {
        interactor.trackEvent(event: Event.onRecipePressedFromBookmarked)
        self.onRecipePressed(recipe: recipe, onRecipePressed: onRecipePressed)
    }

    func onRecipePressedFromTrending(recipe: RecipeTemplateModel, onRecipePressed: ((RecipeTemplateModel) -> Void)? = nil) {
        interactor.trackEvent(event: Event.onRecipePressedFromTrending)
        self.onRecipePressed(recipe: recipe, onRecipePressed: onRecipePressed)
    }

    func onRecipePressedFromMyTemplates(recipe: RecipeTemplateModel, onRecipePressed: ((RecipeTemplateModel) -> Void)? = nil) {
